...
abstract class Season
  ...
  static SeasonIncludeList includeList({
    _i1.WhereExpressionBuilder<SeasonTable>? where,
    int? limit,
    int? offset,
    _i1.OrderByBuilder<SeasonTable>? orderBy,
    bool orderDescending = false,
    _i1.OrderByListBuilder<SeasonTable>? orderByList,
...
class SeasonUpdateTable extends _i1.UpdateTable<SeasonTable> {
...
class SeasonTable extends _i1.Table<_i1.UuidValue?> {
...
class SeasonInclude extends _i1.IncludeObject {
  SeasonInclude._();
  ...
  @override
  _i1.Table<_i1.UuidValue?> get table => Season.t;
}

class SeasonIncludeList extends _i1.IncludeList {
  SeasonIncludeList._({
    _i1.WhereExpressionBuilder<SeasonTable>? where,
    super.limit,
    super.offset,
...
class SeasonRepository {
  ...
  Future<List<Season>> update(
    _i1.DatabaseSession session,
    List<Season> rows, {
    _i1.ColumnSelections<SeasonTable>? columns,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<Season?> updateById(
    _i1.DatabaseSession session,
    _i1.UuidValue id, {
    required _i1.ColumnValueListBuilder<SeasonUpdateTable> columnValues,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<List<Season>> updateWhere(
    _i1.DatabaseSession session, {
    required _i1.ColumnValueListBuilder<SeasonUpdateTable> columnValues,
    required _i1.WhereExpressionBuilder<SeasonTable> where,
    int? limit,
    int? offset,
    _i1.OrderByBuilder<SeasonTable>? orderBy,
    _i1.OrderByListBuilder<SeasonTable>? orderByList,
