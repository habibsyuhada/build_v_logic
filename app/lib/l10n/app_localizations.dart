...
abstract class AppLocalizations {
  ...
  /// No description provided for @settingsColorblindTitle.
  ///
  /// In en, this message translates to:
  /// **'Colorblind-safe palette'**
  String get settingsColorblindTitle;

  /// No description provided for @settingsColorblindSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @settingsScanlineTitle.
  ///
  /// In en, this message translates to:
  /// **'CRT scanline effect'**
  String get settingsScanlineTitle;

  /// No description provided for @settingsScanlineSubtitleDisabled.
  ///
  /// In en, this message translates to:
  /// **'Disabled while reduce motion is on'**
  String get settingsScanlineSubtitleDisabled;

  /// No description provided for @settingsScanlineSubtitleDefault.
  ///
  /// In en, this message translates to:
